      ...
      <div className='accountBox'>
        ...
        <div className='accountRow'>
          ...
          <div className='accountCard'>
            ...
            <div className='cardColumn'>
              ...
              <div className='cardParagraph'>View benefits and payment settings</div>
            </div>
          </div>
        </div>
        <div className='accountRow'>
        <div className='accountCard'>
            ...
            <div className='cardColumn'>
              ...
              <div className='cardParagraph'>View balance, redeem, or reload cards</div>
            </div>
          </div>
          <div className='accountCard'>
            ...
            <div className='cardColumn'>
              ...
              <div className='cardParagraph'>Manage payments methods and settings, view all transactions</div>
            </div>
          </div>
          <div className='accountCard'>
        ...
        <div className='accountCard'>
            ...
            <div className='cardColumn'>
              <div className='cardTitle'> Digital Services and Device Support </div>
          ...
          <div className='accountCard'>
            ...
            <div className='cardColumn'>
              ...
              <div className='cardParagraph'>View messages to and from Amazon, sellers, and buyers</div>
            </div>
          </div>
          <div className='accountCard'>
        ...
        <div className='accountCard'>
            ...
            <div className='cardColumn'>
              ...
              <div className='cardParagraph'>View, modify, and share your lists, or create new ones</div>
            </div>
          </div>
        </div>
      </div>
